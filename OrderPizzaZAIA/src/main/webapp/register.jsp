                        ...
                        <div class="main_login">
                            <div class="signup_right col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="login_box">
                                    ...
                                    <form method="post" id="registrationform" action="RegisterServlet">
                                        <ul>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <input class="form-control" title="RePassword" id="RePassword" name="repassword" type="password">
                                            </li>
                                            <li>
                                                <label for="Phone">手机号码</label>
                                                <input class="form-control" title="Phone" id="phone" name="phone" type="text">
                                            </li>
                                            <li>
                                                <label for="Password">性别</label><br>
                                                <div class="Redio_diltype_left">
                                                    <ul>
                                                        <li>
                                                            <input type="radio" id="M" name="sex" value="M" checked>
                                                            <label for="M">男/Male</label>
                                                        </li>
                                                        <li>
                                                            <input type="radio" id="F" name="sex" value="F">
                                                            <label for="F">女/Female</label>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                <button type="submit" class="register-btn red_btn trans squre-btn hvr-ripple-out" name="Register">注&nbsp;&nbsp;册</button>
                                            </li>
                                        </ul>
                                    </form>
                                    <h4 class="title_checklist">注册代表您同意<a href="#">用户条款</a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
