                    ...
                    <div class="col-md-12">
                        <div class="cart_list">
                            <ul class="inner_cartlist">
                                ...
                                <%--列表--%>
                                <c:forEach items="${userTicket}" var="item2">
                                    <li class="rows">
                                        <div class="edit">
                                            <div class="edit_div"><a href="${pageContext.request.contextPath}/CartServlet?option=moveToCart&mid=${item.menu.menuId}" class="trans del" title="Delete"><i class="fa fa-times" aria-hidden="true"></i></a><a href="#" class="trans edit_new" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></div>
                                        </div>
                                        <div class="pro_name">
                                            <div class="products">
                                                <div class="pro_img"><img src="${pageContext.request.contextPath}/${item2.menu.menuPhoto}" class="absoImg" alt="" height="100px" width="150px"></div>
                                                <div class="pro_descr">
                                                    <h3 class="pro_title"><a href="#" title="Mexican Pizza" class="trans">${item2.menu.menuName}</a></h3>
                                                    <p class="pro_dtls">${fn:substring(item2.menu.menuIntroduction,0,15)}...</p>
                                        ...
                                        <div class="pro_qty">
                                            <div class="number-input">
                                                ...
                                                <input class="quantity" min="0" name="quantity" value="${item2.count}" type="number">

                                            </div>
                                        </div>
                                        <div class="pro_price">
                                            <h4>${item2.menu.menuRetail}</h4></div>
                                        <div class="pro_total">
                                            <h4>${item2.subtotal}</h4></div>
                                    </li>
                                </c:forEach>
                                <%--列表end--%>
                            </ul>
<%--                            <div class="coupan_code">--%>
<%--                                <input type="text" name="Coupancode" class="form-control" placeholder="请输入您的地址">--%>
...
<%--                                    <a href="${pageContext.request.contextPath}/CartServlet?option=clearCart" class="trans gray_btn hvr-ripple" title="Update Cart">清空购物车 </a>--%>
                                    <a href="${pageContext.request.contextPath}/MenuServlet?option=queryAllMenu" class="trans red_btn squre-btn hvr-ripple-out" title="Proceed to Checkout">继续点餐</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 quick_links">
                                ...
                                <div class="main_cnt">
                                    <ul>
                                        ...
                                        <li><a href="register.jsp" class="trans" title="Register">注册</a></li>
